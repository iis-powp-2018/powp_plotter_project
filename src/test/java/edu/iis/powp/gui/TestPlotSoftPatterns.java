...
import edu.iis.powp.events.predefine.PredefinedTestNames;
...
public class TestPlotSoftPatterns {
    ...
    private static void setupPresetTests(Context context) {
        context.addTest("Figure Joe 1", new SelectTestFigureOptionListener(PredefinedTestNames.TEST_FIGURE_JOE_FIRST_SCRIPT));
        context.addTest("Figure Joe 2", new SelectTestFigureOptionListener(PredefinedTestNames.TEST_FIGURE_JOE_SECOND_SCRIPT));
        context.addTest("Figure Jane", new SelectTestFigureOptionListener(PredefinedTestNames.TEST_FIGURE_JANE));
    ...
    private static void setupDrivers(Context context) {
        ...
        DrawPanelController drawerController = ApplicationWithDrawer.getDrawPanelController();
        IPlotter plotter = new LinePlotterAdapter(drawerController, LineFactory.getBasicLine(), "basic");
        context.addDriver("Simple Line Simulator", plotter);
        context.updateDriverInfo();
        plotter = new LinePlotterAdapter(drawerController, LineFactory.getDottedLine() , "dotted");
