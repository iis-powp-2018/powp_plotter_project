...
import edu.iis.powp.adapter.IPloterDrawPanelControllerAdapter;
...
public class TestPlotSoftPatterns
{
	...
	private static void setupDrivers(Context context) {
		...
		IPlotter plotter = new IPloterDrawPanelControllerAdapter();
	...
	private static void setupDefaultDrawerVisibilityManagement(Context context) {
       ...
       defaultDrawerWindow.setVisible(true); //it is an additional window where is so far drawn
	}
    ...
    public static void main(String[] args)
    {
        EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                ...
                //there shouldnt be invoke additional window , so far - i'm commenting it 
                //setupDefaultDrawerVisibilityManagement(context); //it is command which allows showing additional window
