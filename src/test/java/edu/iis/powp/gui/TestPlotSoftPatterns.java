...
import edu.iis.powp.adapter.PlotterDrawPanelControllerAdapter;
...
public class TestPlotSoftPatterns {
    ...
    private static void setupDrivers(Context context) {
        ...
        IPlotter plotter = new PlotterDrawPanelControllerAdapter(ApplicationWithDrawer.getDrawPanelController());
