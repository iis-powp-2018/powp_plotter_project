...
import edu.iis.powp.adapter.BasicLinePlotterToDrawerAdapter;
...
public class TestPlotSoftPatterns
{
	...
	private static void setupPresetTests(Context context) {
		...
		context.addTest("Circle", selectTestFigureOptionListener);
	}
	...
	private static void setupDrivers(Context context) {
		...
		IPlotter plotter = new BasicLinePlotterToDrawerAdapter();
		context.addDriver("Buggy Simulator", plotter);
		
		IPlotter plotterWithSpecialLine = new LinePlotterAdapter();
		context.addDriver("Special line Simulator", plotterWithSpecialLine);
