...
import edu.iis.powp.events.predefine.SelectCustomShapeListener;
...
public class TestPlotSoftPatterns
{
	...
	private static void setupPresetTests(Context context) {
	    ...
	    SelectCustomShapeListener selectCustomShapeListener = new SelectCustomShapeListener();
		context.addTest("Figure Joe 1", selectTestFigureOptionListener);
		context.addTest("Figure Joe 2", selectTestFigureOptionListener);
		context.addTest("Rectangle", selectCustomShapeListener);
		context.addTest("Right Triangle", selectCustomShapeListener);
	}
